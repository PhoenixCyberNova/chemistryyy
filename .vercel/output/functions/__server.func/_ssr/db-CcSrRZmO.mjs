//#region node_modules/.nitro/vite/services/ssr/assets/db-CcSrRZmO.js
...
var _0002_student_state_default = "-- Per-user ChemVault progress (stars, mastery, quiz log, revision queue).\ncreate table if not exists student_state (\n  user_id    text primary key,\n  payload    text not null,\n  updated_at timestamptz not null default now()\n);\n";
/**
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_student_state.sql": _0002_student_state_default
		});
