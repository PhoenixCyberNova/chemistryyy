...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ChGba5Nc.mjs");
...
var manifest = {
	"3d9b8d195d02142ee527bd4b887243a9b9a3fbf18736926791b744105b556aa8": {
		functionName: "askChem_createServerFn_handler",
		importer: () => import("./ask-chem-BwJK3X_Z.mjs")
	},
	"6b006a96ba7db80aaa087efb52077d4f16ace3a5f43ca828b40000e56e11a966": {
		functionName: "loadStudentState_createServerFn_handler",
		importer: () => import("./sync-NSBET5uN.mjs")
	},
	"82bdbdfe7762fe104451afe8e0045b3d7441b5caaed33a9717659b3440bb3443": {
		functionName: "saveStudentState_createServerFn_handler",
		importer: () => import("./sync-NSBET5uN.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Bcxn7Z3H.mjs").then((n) => n.t),
